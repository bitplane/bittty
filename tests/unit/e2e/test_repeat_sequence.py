...
def test_rep_basic(small_board):
    ...
    line = small_board.blitter.current_page.get_line_text(0)
...
def test_rep_with_different_counts():
    ...
    assert board.blitter.current_page.get_line_text(0)[:2] == "XX"
...
def test_rep_with_no_parameter():
    ...
    assert board.blitter.current_page.get_line_text(0)[:2] == "ZZ"
...
def test_rep_with_no_previous_character():
    ...
    assert board.blitter.current_page.get_line_text(0)[:5] == "     "
