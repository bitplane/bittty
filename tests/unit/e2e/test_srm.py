...
def test_srm_default_echo_enabled():
    ...
    assert terminal.modes.local_echo
...
def test_srm_disable_local_echo():
    ...
    assert not terminal.modes.local_echo
...
def test_srm_affects_input_echo():
    ...
    terminal.blitter.write_text("test")
    assert terminal.blitter.current_buffer.get_line_text(0).startswith("test")

    # Clear screen
    terminal.blitter.clear_screen()
...
def test_srm_password_input_scenario():
    ...
    terminal.blitter.write_text("Password: ")
