...
def test_osc_set_both_window_and_icon_title():
    ...
    assert terminal.title.title == "My Board Window"
    assert terminal.title.icon_title == "My Board Window"
...
def test_ps1_osc_title_sequence():
    ...
    assert terminal.cursor.x == len("user@host:/home/user$ ")
...
def test_ps1_with_colors():
    ...
    line_cells = terminal.blitter.current_buffer.get_content()[0]
...
def test_osc_set_icon_title():
    ...
    assert terminal.title.icon_title == "Icon Title"
...
def test_osc_set_window_title_only():
    ...
    assert terminal.title.title == "Window Title"
...
def test_osc_set_empty_title_and_icon():
    ...
    # Set initial titles
    terminal.title.set_title("Initial Title")
    terminal.title.set_icon_title("Initial Icon")

    # OSC 0 with empty title should clear both
    parser.feed("\x1b]0;\x07")

    assert terminal.title.title == ""
    assert terminal.title.icon_title == ""
...
def test_osc_set_title_and_icon_no_semicolon():
    ...
    assert terminal.title.title == "Initial Title"
    assert terminal.title.icon_title == "Initial Icon"
