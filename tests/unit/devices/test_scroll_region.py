...
def test_scroll_up_within_region():
    ...
    terminal.board.screen.set_scroll_region(3, 7)
    ...
    assert terminal.board.screen.current_buffer.get_line_text(2) == "Line 2    "
    ...
    assert terminal.board.screen.current_buffer.get_line_text(5) == "Line 6    "
    assert terminal.board.screen.current_buffer.get_line_text(6) == "Line 7    "
    assert terminal.board.screen.current_buffer.get_line_text(7) == "          "

    # Lines 8-9 should be unchanged
    assert terminal.board.screen.current_buffer.get_line_text(8) == "Line 8    "
    assert terminal.board.screen.current_buffer.get_line_text(9) == "Line 9    "
...
def test_scroll_down_within_region():
    ...
    assert terminal.board.screen.current_buffer.get_line_text(5) == "Line 4    "
    assert terminal.board.screen.current_buffer.get_line_text(6) == "Line 5    "
    assert terminal.board.screen.current_buffer.get_line_text(7) == "Line 6    "
...
def test_line_feed_at_bottom_of_scroll_region():
    ...
    terminal.board.screen.set_scroll_region(2, 5)
    ...
    assert terminal.board.screen.current_buffer.get_line_text(0) == "Line 0    "
    assert terminal.board.screen.current_buffer.get_line_text(1) == "Line 1    "
    assert terminal.board.screen.current_buffer.get_line_text(6) == "Line 6    "
    assert terminal.board.screen.current_buffer.get_line_text(7) == "Line 7    "
    assert terminal.board.screen.current_buffer.get_line_text(8) == "Line 8    "
    assert terminal.board.screen.current_buffer.get_line_text(9) == "Line 9    "
    ...
    assert terminal.board.screen.current_buffer.get_line_text(3) == "Line 4    "
    assert terminal.board.screen.current_buffer.get_line_text(4) == "Line 5    "
    assert terminal.board.screen.current_buffer.get_line_text(5) == "          "
...
def test_multiple_scroll_regions():
    ...
    terminal.board.screen.set_scroll_region(0, 4)
    terminal.board.screen.scroll_up(1)

    # Top half should be scrolled
    assert terminal.board.screen.current_buffer.get_line_text(0) == "Line 1    "
    assert terminal.board.screen.current_buffer.get_line_text(4) == "          "

    # Bottom half should be unchanged
    assert terminal.board.screen.current_buffer.get_line_text(5) == "Line 5    "
    assert terminal.board.screen.current_buffer.get_line_text(9) == "Line 9    "

    # Change scroll region to bottom half
    terminal.board.screen.set_scroll_region(5, 9)
    terminal.board.screen.scroll_up(1)
    ...
    assert terminal.board.screen.current_buffer.get_line_text(5) == "Line 6    "
    assert terminal.board.screen.current_buffer.get_line_text(9) == "          "
...
def test_reset_scroll_region():
    ...
    assert terminal.board.screen.scroll_top == 3
    assert terminal.board.screen.scroll_bottom == 6

    # Reset should restore full terminal
    terminal.board.screen.set_scroll_region(0, 9)  # This is what CSI r with no params should do
