...
def test_write_cell_overwrite_at_end_of_line():
    ...
    board.cursor.y = 0
    board.blitter.write_text("X")
    assert board.blitter.current_page.get_line_text(0) == "abcX      "
...
def test_write_cell_insert_with_style():
    ...
    board.cursor.y = 0
    parser.feed("\x1b[31mX")
    assert board.blitter.current_page.get_line_text(0) == "12X345    "
    assert board.blitter.current_page.get_cell(2, 0) == (parse_sgr_sequence("\x1b[31m"), "X")
...
def test_write_cell_insert_at_end_of_line():
    ...
    parser = Parser(board)
    board.modes.insert_mode = True
    board.blitter.current_page.set(0, 0, "123")
    board.cursor.x = 5
    board.cursor.y = 0
    parser.feed("\x1b[31mX")
    assert board.blitter.current_page.get_line_text(0) == "123  X    "
    assert board.blitter.current_page.get_cell(5, 0) == (parse_sgr_sequence("\x1b[31m"), "X")
...
def test_write_cell_overwrite_at_start_of_line():
    ...
    board.cursor.y = 0
    parser.feed("\x1b[31mX")
    assert board.blitter.current_page.get_line_text(0) == "X2345     "
    assert board.blitter.current_page.get_cell(0, 0) == (parse_sgr_sequence("\x1b[31m"), "X")
...
def test_write_cell_insert_and_truncate():
    ...
    board.cursor.y = 0
    parser.feed("\x1b[31mX")
    assert board.blitter.current_page.get_line_text(0) == "12X34"
    assert board.blitter.current_page.get_cell(2, 0) == (parse_sgr_sequence("\x1b[31m"), "X")
...
def test_write_cell_overwrite_middle_of_line_with_style():
    board = Board(width=10, height=5)
    board.blitter.current_page.set(0, 0, "0123456789")
    board.cursor.x = 5
    board.cursor.y = 0
    board.parser.feed("\x1b[31mX")
    assert board.blitter.current_page.get_line_text(0) == "01234X6789"
    assert board.blitter.current_page.get_cell(5, 0) == (parse_sgr_sequence("\x1b[31m"), "X")
...
def test_write_cell_insert_middle_of_line_with_style():
    ...
    board.cursor.y = 0
    board.parser.feed("\x1b[31mX")
    assert board.blitter.current_page.get_line_text(0) == "01234X5678"
    assert board.blitter.current_page.get_cell(5, 0) == (parse_sgr_sequence("\x1b[31m"), "X")
...
def test_write_cell_insert_at_start_of_line_with_style():
    ...
    board.cursor.y = 0
    board.parser.feed("\x1b[31mX")
    assert board.blitter.current_page.get_line_text(0) == "X012345678"
    assert board.blitter.current_page.get_cell(0, 0) == (parse_sgr_sequence("\x1b[31m"), "X")
...
def test_write_cell_insert_at_end_of_line_with_style():
    board = Board(width=10, height=5)
    board.modes.insert_mode = True
    board.blitter.current_page.set(0, 0, "012345678")
    board.cursor.x = 9
    board.cursor.y = 0
    board.parser.feed("\x1b[31mX")
    assert board.blitter.current_page.get_line_text(0) == "012345678X"
    assert board.blitter.current_page.get_cell(9, 0) == (parse_sgr_sequence("\x1b[31m"), "X")
...
def test_write_cell_overwrite_beyond_end_of_line_with_style():
    ...
    board.cursor.y = 0
    board.parser.feed("\x1b[31mX")
    assert board.blitter.current_page.get_line_text(0) == "abc  X    "
    assert board.blitter.current_page.get_cell(5, 0) == (parse_sgr_sequence("\x1b[31m"), "X")
...
def test_long_print_run_wraps_across_lines():
    ...
    assert page.get_line_text(0) == "A" * 10
    assert page.get_line_text(1) == "A" * 10
    assert page.get_line_text(2) == "A" * 5 + " " * 5
...
def test_long_print_run_scrolls_at_the_bottom():
    ...
    page = board.blitter.current_page
    assert page.get_line_text(1) == "B" * 10
    assert page.get_line_text(2) == "B" * 5 + " " * 5
    assert board.cursor.y == 2
