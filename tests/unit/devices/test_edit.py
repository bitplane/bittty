...
def test_write_cell_overwrite():
    ...
    assert terminal.board.screen.current_buffer.get_cell(0, 0) == (parse_sgr_sequence("\x1b[31m"), "A")
    assert terminal.board.cursor.x == 1

    parser.feed("\x1b[32m")  # Set green color
    parser.feed("B")
    assert terminal.board.screen.current_buffer.get_line_text(0) == "AB        "
    assert terminal.board.screen.current_buffer.get_cell(1, 0) == (parse_sgr_sequence("\x1b[32m"), "B")
    assert terminal.board.cursor.x == 2

    terminal.board.cursor.set_position(0, 0)
    parser.feed("\x1b[34m")  # Set blue color
    parser.feed("C")
    assert terminal.board.screen.current_buffer.get_line_text(0) == "CB        "
    assert terminal.board.screen.current_buffer.get_cell(0, 0) == (parse_sgr_sequence("\x1b[34m"), "C")
    assert terminal.board.cursor.x == 1
...
def test_write_cell_insert_mode():
    ...
    parser.feed("\x1b[34m")  # Set blue color
    parser.feed("C")
    assert terminal.board.screen.current_buffer.get_line_text(0) == "CAB       "
    assert terminal.board.screen.current_buffer.get_cell(0, 0) == (parse_sgr_sequence("\x1b[34m"), "C")
    assert terminal.board.screen.current_buffer.get_cell(1, 0) == (parse_sgr_sequence("\x1b[31m"), "A")
    assert terminal.board.screen.current_buffer.get_cell(2, 0) == (parse_sgr_sequence("\x1b[32m"), "B")
    assert terminal.board.cursor.x == 1
...
def test_write_cell_autowrap():
    ...
    assert terminal.board.screen.current_buffer.get_line_text(1) == "D  "
    assert terminal.board.cursor.x == 1
...
def test_clear_rect():
    ...
    terminal.board.screen.clear_rect(1, 1, 3, 3)

    for y in range(5):
        for x in range(5):
            if 1 <= x <= 3 and 1 <= y <= 3:
                assert terminal.board.screen.current_buffer.get_cell(x, y) == (Style(), " ")
            else:
                assert terminal.board.screen.current_buffer.get_cell(x, y) == (parse_sgr_sequence("\x1b[31m"), "X")
...
def test_clear_screen():
    ...
    terminal.board.screen.clear_screen(constants.ERASE_FROM_CURSOR_TO_END)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "AAAAAAAAAA"
    assert terminal.board.screen.current_buffer.get_line_text(1) == "BBBBBBBBBB"
    assert terminal.board.screen.current_buffer.get_line_text(2) == "CCCCC     "
    assert terminal.board.screen.current_buffer.get_line_text(3) == "          "
    ...
    terminal.board.screen.clear_screen(constants.ERASE_FROM_START_TO_CURSOR)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "          "
    assert terminal.board.screen.current_buffer.get_line_text(1) == "          "
    assert terminal.board.screen.current_buffer.get_line_text(2) == "      CCCC"
    assert terminal.board.screen.current_buffer.get_line_text(3) == "DDDDDDDDDD"
    assert terminal.board.screen.current_buffer.get_line_text(4) == "EEEEEEEEEE"
    ...
    terminal.board.screen.clear_screen(constants.ERASE_ALL)
    for y in range(5):
        assert terminal.board.screen.current_buffer.get_line_text(y) == "          "
...
def test_clear_line():
    ...
    assert terminal.board.screen.current_buffer.get_line_text(0) == "XXXXX     "
    ...
    terminal.board.screen.clear_line(constants.ERASE_FROM_START_TO_CURSOR)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "      XXXX"
    ...
    terminal.board.screen.clear_line(constants.ERASE_ALL)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "          "
...
def test_insert_lines():
    ...
    terminal.board.screen.insert_lines(1)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "Line 0    "
    assert terminal.board.screen.current_buffer.get_line_text(1) == "Line 1    "
    assert terminal.board.screen.current_buffer.get_line_text(2) == "          "
    assert terminal.board.screen.current_buffer.get_line_text(3) == "Line 2    "
    ...
    terminal.board.screen.insert_lines(2)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "Line 0    "
    assert terminal.board.screen.current_buffer.get_line_text(1) == "          "
    assert terminal.board.screen.current_buffer.get_line_text(2) == "          "
    assert terminal.board.screen.current_buffer.get_line_text(3) == "Line 1    "
    assert terminal.board.screen.current_buffer.get_line_text(4) == "Line 2    "
...
def test_delete_lines():
    ...
    terminal.board.screen.delete_lines(1)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "Line 0    "
    assert terminal.board.screen.current_buffer.get_line_text(1) == "Line 2    "
    assert terminal.board.screen.current_buffer.get_line_text(2) == "Line 3    "
    assert terminal.board.screen.current_buffer.get_line_text(3) == "Line 4    "
    assert terminal.board.screen.current_buffer.get_line_text(4) == "          "
    ...
    for y in range(5):
        terminal.board.screen.current_buffer.set(0, y, f"Line {y}")
    terminal.board.cursor.set_position(0, 0)
    terminal.board.screen.delete_lines(2)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "Line 2    "
    assert terminal.board.screen.current_buffer.get_line_text(1) == "Line 3    "
    assert terminal.board.screen.current_buffer.get_line_text(2) == "Line 4    "
    assert terminal.board.screen.current_buffer.get_line_text(3) == "          "
    assert terminal.board.screen.current_buffer.get_line_text(4) == "          "
...
def test_insert_characters():
    ...
    terminal.board.screen.insert_characters(3)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "AB   CDEFG"
...
def test_delete_characters():
    ...
    terminal.board.screen.delete_characters(2)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "125       "
...
def test_delete_characters_from_middle_of_line():
    ...
    terminal.board.cursor.x = 2
    terminal.board.cursor.y = 0
    terminal.board.screen.delete_characters(3)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "126789    "
...
def test_delete_characters_beyond_end_of_line():
    ...
    terminal.board.cursor.x = 2
    terminal.board.cursor.y = 0
    terminal.board.screen.delete_characters(10)  # Attempt to delete more than available
    assert terminal.board.screen.current_buffer.get_line_text(0) == "12        "
...
def test_delete_last_character_on_line():
    ...
    terminal.board.cursor.y = 0
    terminal.board.screen.delete_characters(1)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "abcd      "
...
def test_insert_characters_at_end_of_line():
    ...
    terminal.board.cursor.y = 0
    terminal.board.screen.insert_characters(2)
    assert terminal.board.screen.current_buffer.get_line_text(0) == "12345     "
...
def test_insert_characters_with_padding_preserves_style_objects():
    ...
    terminal.board.screen.insert_characters(2, Style(italic=True))

    # Check that all cells have proper Style objects
    row = terminal.board.screen.current_buffer.grid[0]
