...
- Printer pages currently cover DEC PPL text, controls, margins, wrapping, form feeds, and CRM tokens; richer layout commands, graphics, and mechanical timing remain unsupported.
