...
- Printer pages currently cover DEC PPL text runs, basic controls, form feeds, and CRM tokens; margins, wrapping, richer layout, graphics, and mechanical timing remain unsupported.
